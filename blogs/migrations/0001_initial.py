    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(max_length=250, null=True, upload_to='uploads/images/%Y/%m/%d/%H/%M/%S/', verbose_name='Аватарка')),
            ],
            options={
                'verbose_name': 'Блог',
        ...
        migrations.CreateModel(
            name='TopicContent',
            fields=[
                ('topic', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='blogs.topic', verbose_name='Топик')),
        ...
        migrations.CreateModel(
            name='UserProfile',
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='blogs.user', verbose_name='Пользователь')),
                ('sex', models.CharField(choices=[('Male', 'Мужской'), ('Female', 'Женский')], max_length=10)),
                ('country', models.CharField(default='NULL', max_length=30, null=True)),
                ('region', models.CharField(default='NULL', max_length=30, null=True)),
                ('city', models.CharField(default='NULL', max_length=30, null=True)),
                ('birthday', models.DateField(blank=True, default=None, null=True)),
                ('about', models.TextField(default='NULL', null=True)),
                ('avatar', models.ImageField(max_length=250, null=True, upload_to='uploads/images/%Y/%m/%d/%H/%M/%S/')),
            ],
            options={
